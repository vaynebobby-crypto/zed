...
use crate::provider::{
    ...
    mistral::MistralSettings, moonshot::MoonShotSettings, ollama::OllamaSettings, open_ai::OpenAiSettings,
...
impl settings::Settings for AllLanguageModelSettings {
    ...
    fn from_settings(content: &settings::SettingsContent) -> Self {
        ...
        let moonshot = language_models.moonshot.unwrap();
        ...
        Self {
            ...
            moonshot: MoonShotSettings {
                api_url: moonshot.api_url.unwrap(),
                available_models: moonshot.available_models.unwrap_or_default(),
            },
